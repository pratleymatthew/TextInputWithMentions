 ...
 */
public class GetFileContentsFromTemp extends CustomJavaAction<java.lang.Boolean>
{
	private java.lang.String filename;
	private IMendixObject __fileDocument;
	private system.proxies.FileDocument fileDocument;

	public GetFileContentsFromTemp(IContext context, java.lang.String filename, IMendixObject fileDocument)
	{
		super(context);
	...
	public java.lang.Boolean executeAction() throws Exception
	{
		...
		// BEGIN USER CODE
		File myFile = new File(Core.getConfiguration().getTempPath() + File.separator + filename);
	...
	{
		return "GetFileContentsFromTemp";
	}
